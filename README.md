# com-chilipeppr-workspace-treybert
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-treybert |
| Name                  | Workspace / grbl |
| Description           | A ChiliPeppr Workspace grbl. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/treybert3/workspace-treybert/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/treybert/chilipeppr-treybert |
| Github URL            | http://github.com/treybert3/workspace-treybert |
| Test URL              | https://preview.c9users.io/treybert/chilipeppr-treybert/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/treybert3/workspace-treybert/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-treybert"], // the id you gave your workspace
      function(myWorkspaceTreybert) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / grbl just got loaded.", myWorkspaceTreybert);
        myWorkspaceTreybert.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-treybert"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / grbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace grbl."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/treybert3/workspace-treybert/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/treybert/chilipeppr-treybert"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/treybert3/workspace-treybert"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chilipeppr-treybert-treybert.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
