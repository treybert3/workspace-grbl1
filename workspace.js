...
cprequire_test(["inline:com-chilipeppr-workspace-treybert"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-treybert", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-treybert", // Make the id the same as the cpdefine id
        ...
        loadWidgets: function(callback) {
            ...
            chilipeppr.load(
                ...
                "http://fiddle.jshell.net/treybert/9bxc3z2s/3/show/light/",
